package org.cerberus.testbed.model;
				...
				public void run() {
					...
					try {
						...
						String cmd = adbPath
								+ " -s "
								+ deviceName
								+ " shell am instrument -w -e class org.cerberus.test.CerberusTestRunner#testRun com.example.testandroid/android.test.InstrumentationTestRunner";
						System.out.println(cmd);
						process = runtime.exec(cmd);
						// process.waitFor();
						InputStream is = process.getInputStream();
