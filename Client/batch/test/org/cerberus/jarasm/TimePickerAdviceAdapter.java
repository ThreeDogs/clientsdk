...
public class TimePickerAdviceAdapter extends AdviceAdapter {

private String log;
	
	protected TimePickerAdviceAdapter(int api, MethodVisitor mv,
	...
	protected void onMethodEnter() {
		...
		mv.visitVarInsn(ALOAD, 0);
		mv.visitFieldInsn(GETFIELD, "com/autoschedule/proto/view/SettingsActivity$1", "this$0", "Lcom/autoschedule/proto/view/SettingsActivity;");
		mv.visitMethodInsn(INVOKEVIRTUAL, "com/autoschedule/proto/view/SettingsActivity", "getResources", "()Landroid/content/res/Resources;");
		mv.visitVarInsn(ALOAD, 1);
		mv.visitMethodInsn(INVOKEVIRTUAL, "android/widget/TimePicker", "getId", "()I");
